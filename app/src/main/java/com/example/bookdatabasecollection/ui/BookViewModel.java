...
import com.example.bookdatabasecollection.ui.data.entities.AuthorEntity;
...
public class BookViewModel extends AndroidViewModel {
    ...
    public void populateDataBase(){
        ...
        book1.setAuthorEntity(new AuthorEntity("Ernest Hemingway", "07/21/1899"));
        book1.setUrl("https://en.wikipedia.org/wiki/The_Old_Man_and_the_Sea");

        book2.setTitle("To Kill a Mockingbird");
        book2.setPublishedDate("07/11/1960");
        book2.setAuthorEntity(new AuthorEntity("Harper Lee", "04/28/1926"));
        ...
        book3.setAuthorEntity(new AuthorEntity("F. Scott Fitzgerald", "09/24/1896"));
        ...
        book4.setAuthorEntity(new AuthorEntity("George Orwell", "06/25/1903"));
        ...
        book5.setAuthorEntity(new AuthorEntity("J. D. Salinger", "01/01/1919"));
